...
readable_run make -j$(nproc) -f tensorflow/lite/micro/tools/make/Makefile \
CXXFLAGS="-DTF_LITE_STATIC_MEMORY -std=c++11 -Wno-error=incompatible-pointer-types -Wall -Wpointer-arith -Werror -Wdouble-promotion -Wfloat-conversion -nostdlib -DTF_LITE_STATIC_MEMORY=1 \
